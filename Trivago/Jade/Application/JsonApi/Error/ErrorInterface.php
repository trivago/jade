...
namespace Trivago\Jade\Application\JsonApi\Error;

use Neomerx\JsonApi\Contracts\Document\ErrorInterface as BaseErrorInterface;

interface ErrorInterface extends BaseErrorInterface
{
    /**
